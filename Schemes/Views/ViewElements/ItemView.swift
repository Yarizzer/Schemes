...
//  Schemes
//
//  Created by Yaroslav Abaturov on 18/07/2018.
//  Copyright © 2018 Yaroslav Abaturov. All rights reserved.
//

import UIKit

class ItemView: UIView, CAAnimationDelegate {
    
    var itemModel: ItemViewModelType?
...
//    var lockView = UIView()
    ...
    convenience init(withModel model: ItemViewModelType) {
        self.init(frame: CGRect(x: 0, y: 0, width: 160 , height: 125))
...
//        animateAppearing()
    ...
    private func setupDefaultViewProreties() {
        ...
        discriptionTextField = UITextView(frame: CGRect(origin: CGPoint(x: 5, y: 35), size: CGSize(width: 150, height: 50)))
        ...
        actionButton = UIButton(frame: CGRect(origin: CGPoint(x: 125, y: 90), size: CGSize(width: 30, height: 30)))
...
//        lockView = UIView(frame: CGRect(origin: .zero, size: CGSize(width: 15, height: 15)))
//        lockView.backgroundColor = UIColor.yellow
//        lockView.center = actionButton.center
        
//        actionButton.addSubview(lockView)
        
        settingsButton = UIButton(frame: CGRect(origin: CGPoint(x: 5, y: 90), size: CGSize(width: 30, height: 30)))
    ...
    private func setValues() {
        ...
        if model.titleText == "" {
            ...
            titleTextField.text = model.titleText
            discriptionTextField.text = model.discriptionText
        }
    }
...
//        })
    ...
    private func animateOpeningItem() {
        ...
        UIView.transition(with: self, duration: 0.5, options: [.curveEaseInOut], animations: { [unowned self] in
            ...
            self.actionButton.center.y = 105
